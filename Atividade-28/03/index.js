...
let titular = [
    {nome: "Abigael Natte", conta:"5486273622", tipo_de_conta: "Conta Corrente", saldo: 27771},
    {nome: "Ramon Connell", conta: "1183971869", tipo_de_conta: "Conta Poupança", saldo: 8675}
];


let contaBanco = 
titular.find(function(contaBanco){
    return contaBanco.nome === 'Abigael Natte';
})
